...
## Chamada Combinada (Recomendada)

**Uma única requisição HTTP** para LABEL_DETECTION + OBJECT_LOCALIZATION:
...
**Limites gratuitos:** 1.000 unidades/mês por feature (Label + Object = 2 unidades por imagem)
...
- [ ] Montar request com `features: [LABEL_DETECTION (maxResults: 5), OBJECT_LOCALIZATION (maxResults: 1)]`
